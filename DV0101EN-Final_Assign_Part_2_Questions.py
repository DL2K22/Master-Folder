...
def update_input_container(selected_statistics):
    if selected_statistics == 'Yearly Statistics':
        return "You selected Yearly Statistics."
    elif selected_statistics == 'Recession Period Statistics':
        return "You selected Recession Period Statistics."
    else:
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values='Total_Expenditure', names='Vehicle_Type',
                                           title='Total Advertisement Expenditure by Vehicle Type in {}'.format(input_year)))
